...
import {ViewFooter, ContainerPT, ContainerP,ConteudoEstabelecimentos} from './styles'
...
const ListPlaces = ({
  ...
  <ContainerPT>
    <View style={{margin: 20}}>
      ...
      <View style={{flexDirection:"row", justifyContent:"flex-start", alignItems:"center", paddingBottom: 5, maxWidth: 300, marginBottom: 10}}>
